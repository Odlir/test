...
<div class="page-wrapper">
    ...
    <div class="main supporting" id="zen-supporting" role="main">
		...
		<div class="form" id="zen-form" role="article">
			<p class="subtitulo thick">Talentos espec&iacute;ficos <span class="rojo">menos desarrollados</span></p>
            <p class="aclaracion">Si consideras que tienes alguno de estos talentos espec&iacute;ficos como m&aacute;s desarrollado, m&aacute;rcalo.<br />Puedes elegir entre <?php echo $menos_especificos_minimo; ?> y <?php echo $menos_especificos_maximo; ?> talentos</p>
            ...
            <form id="formulario" method="post" accept-charset="utf-8" >
                <input type="hidden" name="pagina" value="especificos_menos" />
            ...
            <select multiple="multiple" class="image-picker show-html" data-limit=<?php echo $menos_especificos_maximo; ?>>
            ...
            <div id="resumen">
                <div class="izquierda"><input id="cantidad" readonly="readonly"/> seleccionado de <?php echo $menos_especificos_maximo; ?></div>
...
<script type="text/javascript">
    ...
    $( "select" ).change(function() {
        ...
        if (count == <?php echo $menos_especificos_maximo; ?>) {
            $.post('<?php echo site_url()."formulario/mostrar_ventana/"; ?>', {ventana:"modal",msg:'Has terminado de elegir tus <?php echo $menos_especificos_maximo; ?> talentos menos desarrollados. Si est\u00E1s seguro de tus respuestas, haz click en CONTINUAR.'},
            function(data){
                $("#popup").html(data); 
                $("#popup").dialog( "open" );
            });
    ...
    $(function() {
       $("#loading").hide();
        $("form").submit(function (event ) {
            ...
            $( "input[name='menos']" ).val( $("select").data('picker').selected_values());

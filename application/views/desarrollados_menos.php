...
<div class="page-wrapper">
    ...
    <div class="main supporting" id="zen-supporting" role="main">
		...
		<div class="form" id="zen-form" role="article">
			<p class="subtitulo thick">Talentos <span class="rojo">menos desarrollados</span></p>

            <p class="aclaracion">Elige tus (<?php echo $menos_desarrollados_maximo; ?>) talentos menos desarrollados.</p>
            ...
            <form id="formulario" method="post" accept-charset="utf-8" >
                <input type="hidden" name="pagina" value="desarrollados_menos" />
            ...
            <select multiple="multiple" class="image-picker show-html" data-limit=<?php echo $menos_desarrollados_maximo; ?>>
                <?php foreach ($menos_desarrollados as $row => $value): ?>
            ...
            <div id="resumen">
                <div class="izquierda"><input id="cantidad" readonly="readonly"/> seleccionado de <?php echo $menos_desarrollados_maximo; ?></div>
                <div class="derecha">Total: <?php echo count($menos_desarrollados); ?></div>
            </div>
		</div>
...
<script type="text/javascript">
    ...
    $( "select" ).change(function() {
        ...
        $("#cantidad").val(count);
        if (count == <?php echo $menos_desarrollados_maximo; ?>) {
            $.post('<?php echo site_url()."formulario/mostrar_ventana/"; ?>', {ventana:"modal",msg:'Has terminado de elegir tus <?php echo $menos_desarrollados_maximo; ?> talentos menos desarrollados. Si est\u00E1s seguro de tus respuestas, haz click en CONTINUAR.'},
            function(data){
                $("#popup").html(data); 
                $("#popup").dialog( "open" );
            });

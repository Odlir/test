...
(function() {
  ...
  ImagePickerOption = (function() {
    ...
    ImagePickerOption.prototype.create_node = function() {
      ...
      if (this.opts.show_image) {
        input = jQuery("<input class='show'/>");
        input.attr("type", "image");
        input.attr("src", this.option.data("img-src-ver"));
        var back, front;
        back = this.option.data("img-src-back");
        front = this.option.data("img-src-front");
        input.click(function(){
            var box = $(this).parent();
            var target = '';
            if (box.find('img').attr('src')==back)
            {
                target = front;
            }
            else
